/**
 * LayerConfig - configuration for Martin vector tile layers
 * 
 * Defines layer sources, styles, and category-based styling
 */
...
// ============================================
// Road Network Categories (OSI SUSH)
// ============================================
...
/**
 * Generate MapLibre style expression for category-based coloring
 */
...
/**
 * Generate MapLibre style expression for category-based width
 */
