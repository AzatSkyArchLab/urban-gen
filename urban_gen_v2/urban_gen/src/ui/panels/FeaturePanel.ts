...
export class FeaturePanel extends BasePanel {
  ...
  protected setupEventListeners(): void {
    ...
    // Subscribe to events
    this.subscribe('features:changed', () => this.renderFeatureList());
  ...
  private updateCount(): void {
    const countEl = this.container.querySelector('.feature-count');
    if (countEl) {
      countEl.textContent = String(this.featureStore.count);
    }
  }
}
